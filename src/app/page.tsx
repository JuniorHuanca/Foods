...
const Home = (props: Props) => {
  return (
    <main className="w-full h-full">
      <div className="w-full h-full bg-home bg-repeat bg-cover">
        ...
        <div className="min-h-[90vh] flex justify-center items-center">
          <div className="flex flex-col justify-center items-center p-4 bg-black/50 rounded-md text-white">
            ...
            <Link href={"#hola"} className="my-2 rounded-lg">
      ...
      >
        <div className="w-full flex flex-col gap-10 justify-center items-center p-4 bg-white/50 dark:bg-black/50 rounded-md">
          <div className="flex items-center w-full">
            <span className="flex-grow h-0 border-b-2"></span>
